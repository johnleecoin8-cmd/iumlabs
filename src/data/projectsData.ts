...
export const projectsData: Record<string, ProjectData> = {
  "bnb-chain": {
    ...
    metrics: [
      ...
      { value: "150+", label: "VIP Inviters" },
      { value: "2K+", label: "Community Members" },
      { value: "1", label: "Offline Meet-up" }
    ],
    strategy: [
  ...
  "kucoin": {
    ...
    metrics: [
      { value: "550M+", label: "TVL" },
      { value: "+600%", label: "SEO Keyword" },
  ...
  "polygon": {
    ...
    metrics: [
      { value: "$2M", label: "Korean TVL" },
      { value: "200+", label: "Meet-up Participants" },
      { value: "500+", label: "DeFi Integrations" },
      { value: "30 Days", label: "Time to Achieve" }
    ],
    strategy: [
  ...
  "megaeth": {
    ...
    whatWeDid: "We architected a pre-launch campaign that turned MegaETH into Korea's most anticipated L2. Through exclusive technical deep-dives, early testnet access programs, and strategic AMAs with Korean crypto media, we built a community of 30K+ genuine believers. Our content positioning emphasized MegaETH's real-time capabilities in ways that resonated with Korea's gaming and trading communities.",
    metrics: [
      { value: "3M+", label: "ICO" },
      { value: "1K+", label: "Mindshare in Korea" },
      { value: "2K+", label: "Testnet Users" },
  ...
  "tria": {
    ...
    challenge: "Korea's wallet market is brutally competitive—dominated by established players and local solutions integrated with Korean apps. Tria needed to convince users that a new wallet, from an unknown brand, was worth the switch. The challenge was demonstrating their simplified UX advantage without access to the Korean app store ecosystem.",
    whatWeDid: "We positioned Tria as the wallet for Korea's next generation of Web3 users. Through strategic influencer partnerships showcasing the seamless UX, referral campaigns with compelling incentives, and integrations with popular Korean dApps, we drove 30K+ wallet creations. Our localized tutorial content and Korean-language support infrastructure ensured users stayed engaged post-signup.",
    metrics: [
      { value: "450K+", label: "Total Impressions" },
      { value: "+250%", label: "Community Growth" },
      { value: "15+", label: "Articles Media Coverage" },
  ...
  "bybit": {
    ...
    challenge: "Korea's exchange market is a fortress dominated by local giants. Bybit faced regulatory scrutiny, user skepticism toward foreign platforms, and the need to localize everything from customer support to trading pairs. Winning Korea meant more than marketing—it required becoming a truly Korean-friendly platform.",
    whatWeDid: "We executed a comprehensive market entry strategy that transformed Bybit's Korean presence. High-profile offline events in Seoul attracted thousands of traders, while our VIP program created an exclusive community of high-volume Korean users. Multi-channel campaigns—from esports partnerships to trading competitions—drove sustained user acquisition and positioned Bybit as the sophisticated trader's choice.",
    metrics: [
      { value: "#2", label: "Market Position" },
      { value: "+1.5B", label: "TVL" },
      { value: "1200+", label: "Users" },
      { value: "+5 Months", label: "Campaign Duration" }
    ],
    strategy: [
  ...
  "sahara-ai": {
    ...
    glowColor: "#00D4FF",
    description: "Sahara AI is building the decentralized AI infrastructure layer, enabling secure and private AI model training and deployment on blockchain. As AI and Web3 converge into one of crypto's hottest narratives, Sahara sought to establish themselves as the category leader in Korea—a market with world-class AI talent and deep crypto adoption.",
    challenge: "The AI x Web3 intersection was nascent in Korea, with most users familiar with either AI or crypto but rarely both. Sahara needed to educate developers and enterprises on decentralized AI while competing against well-funded competitors racing to own the same narrative.",
    whatWeDid: "We positioned Sahara as Korea's gateway to the AI blockchain future. Through a series of immersive launch events showcasing live technology demonstrations, we connected Sahara with Korea's AI developer community, university researchers, and enterprise decision-makers. Our campaigns reached 200K+ community members and generated 25+ partnership opportunities with Korean AI companies.",
    metrics: [
      { value: "400+", label: "Meet-up Participants" },
      { value: "200K+", label: "Community Members" },
      { value: "25+", label: "Partnership Deals" },
      { value: "10", label: "Launch Events" }
    ],
    strategy: [
  ...
  "mantra": {
    ...
    glowColor: "#9B59B6",
    description: "Mantra is the security-first RWA Layer 1 blockchain, purpose-built for tokenizing real-world assets with regulatory compliance at its core. With partnerships across Middle Eastern sovereign wealth and major financial institutions, Mantra sought to establish a Korean beachhead to access the region's sophisticated institutional investor base.",
    challenge: "Korean institutional investors are among the world's most demanding, requiring regulatory clarity, proven partnerships, and credible security audits. Mantra needed to translate their Middle Eastern success into Korean market credibility while building relationships with local financial institutions unfamiliar with the project.",
    whatWeDid: "We crafted an institutional-first market entry that positioned Mantra as the compliant RWA solution for Korean finance. Our PR strategy secured features in major Korean financial media, while targeted outreach built a pipeline of $50M+ in institutional interest. Community growth initiatives created grassroots momentum that amplified institutional credibility, ultimately facilitating Mantra's successful Korean CEX listing.",
    metrics: [
      { value: "$50M+", label: "Pipeline" },
      { value: "Completed", label: "Korea CEX" },
      { value: "130K+", label: "Impressions" },
      { value: "4+", label: "Media Features" }
    ],
    strategy: [
  ...
  "synfutures": {
    ...
    glowColor: "#6366F1",
    description: "SynFutures is the leading decentralized derivatives exchange, pioneering permissionless perpetual futures trading with innovative AMM mechanisms. As DeFi derivatives gained mainstream traction, SynFutures sought to establish dominant brand presence in Korea—a market known for its love of derivatives trading on centralized exchanges.",
    challenge: "Korean traders were heavily invested in centralized derivatives platforms, with DeFi perpetuals perceived as complex and risky. SynFutures needed to break through the noise with a brand awareness campaign that would plant their name in the minds of Korea's most active traders.",
    whatWeDid: "We executed a high-impact OOH campaign that put SynFutures front and center in Gangnam—Korea's financial and crypto heartland. Premium billboard placements generated 5M+ impressions, while coordinated digital campaigns amplified the visibility. Our AMA series with Korean trading communities drove education and engagement, converting awareness into active users.",
    metrics: [
  ...
  "fogo": {
    ...
    glowColor: "#FF6B35",
    description: "FOGO is building a next-generation high-performance blockchain optimized for real-time applications and global scale. With backing from top-tier investors and a team of infrastructure veterans, FOGO targeted Korea as a strategic launch market to build an engaged community of early believers ahead of their network launch.",
    challenge: "As an emerging infrastructure project without a live network, FOGO faced the challenge of building community enthusiasm based on vision alone. The Korean market, saturated with L1 and L2 projects, demanded differentiation and genuine value propositions to cut through the noise.",
    whatWeDid: "We built FOGO's Korean presence from zero to thriving community. Our launch event attracted 250+ attendees, while our KOL partnership program onboarded 55+ influential voices who authentically championed FOGO's vision. Strategic media placements and community engagement initiatives drove 250% growth, establishing FOGO as one of the most anticipated infrastructure launches in the Korean market.",
    metrics: [
      { value: "250+", label: "Event Attendees" },
  ...
  "openledger": {
    ...
    glowColor: "#10B981",
    description: "OpenLedger is pioneering decentralized AI data infrastructure, enabling secure and transparent data sharing for AI model training. As the AI x Web3 narrative exploded globally, OpenLedger sought to establish early dominance in Korea—a market with world-class AI research institutions and a sophisticated crypto-native audience.",
    ...
    whatWeDid: "We executed a comprehensive community and PR strategy that positioned OpenLedger as a thought leader in decentralized AI infrastructure. Our KOL partnerships reached 100+ influential voices, generating 30M+ community impressions. Strategic media placements and executive interviews established OpenLedger's credibility with both crypto natives and AI-focused audiences across Korea.",
    metrics: [
      { value: "30M+", label: "Community Reach" },
      { value: "100+", label: "KOL Partners" },
      { value: "25K+", label: "Social Impressions" },
      { value: "2+", label: "Media Coverage" }
    ],
    strategy: [
