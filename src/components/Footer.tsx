...
const Footer = () => {
  return <footer className="bg-background text-foreground pb-[env(safe-area-inset-bottom)]">
      {/* Giant Brand Name - Static */}
      <div className="w-full px-4 sm:px-6 py-6 sm:py-8 overflow-hidden bg-background md:py-[20px]">
