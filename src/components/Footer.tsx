...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0A0A0A] text-white" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
      {/* Giant brand name */}
      <div className="px-4 sm:px-6 lg:px-10 pt-10 sm:pt-16 pb-6 sm:pb-10 overflow-hidden">
        <h2 className="text-[15vw] sm:text-[12vw] font-bold text-white/[0.07] leading-[0.85] tracking-[-0.04em] whitespace-nowrap select-none">
          ium Labs
        </h2>
      </div>
