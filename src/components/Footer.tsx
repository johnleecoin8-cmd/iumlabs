...
const Footer = () => {
  ...
  return (
    <footer className="bg-[hsl(0,0%,3%)] text-white">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-emerald-500/30 flex items-center justify-center hover:bg-emerald-500/10 hover:border-emerald-400 transition-colors"
              >
      ...
      <div className="container mx-auto px-6 pb-12 overflow-hidden">
        <h2 className="text-[6rem] md:text-[10rem] lg:text-[14rem] font-light leading-none tracking-tight text-center">
          <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(16,185,129,0.2)' }}>
            {brandConfig.name}
          </span>
        </h2>
      </div>
