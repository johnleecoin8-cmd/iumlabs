        ...
        <div className={`container mx-auto max-w-5xl text-center relative z-10 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a 
              ...
              className="group w-full sm:w-auto flex items-center justify-center gap-2 px-6 md:px-8 py-4 md:py-5 rounded-xl border border-white/20 text-white font-medium hover:bg-white/10 hover:border-white/40 transition-all"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-start">
            ...
            <div className="space-y-4 order-2 lg:order-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                <a 
                  href={`mailto:${brand.email}`}
                  className="group relative flex flex-col items-start gap-2 p-4 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-primary/40 hover:-translate-y-1 transition-all duration-500"
                >
            ...
            <div className="order-1 lg:order-2">
              <form 
                ...
                className="group space-y-4 p-5 md:p-7 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:border-primary/20 transition-all duration-500"
              >
                {/* Progress Indicator */}
