    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-[100vh]">
        ...
        <motion.div
          ...
          <h2 className="font-display text-[clamp(1.7rem,5.6vw,4.9rem)] font-bold text-white mb-6 sm:mb-9 tracking-[-0.005em] leading-[0.95] sm:leading-[0.92] sm:whitespace-nowrap">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <div className="text-gradient-hero font-display text-3xl sm:text-5xl md:text-6xl font-bold tracking-[-0.005em] leading-none mb-2 sm:mb-3">
                  {stat.value}
                </div>
