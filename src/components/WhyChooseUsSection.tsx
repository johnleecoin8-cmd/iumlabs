...
const WhyChooseUsSection = () => {
  ...
  return <section className="relative bg-[#F5F2ED] py-16 overflow-hidden md:py-[20px]">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        {/* Option B Header */}
        <motion.div className="relative mb-8 md:mb-12" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        delay: 0.5
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="flex items-center animate-marquee-slow hover:[animation-play-state:paused]">
              {[...mediaLogos, ...mediaLogos, ...mediaLogos].map((media, index) => <div key={index} className="flex items-center gap-3 mx-3 px-5 py-2.5 bg-white rounded-2xl border border-gray-100 hover:border-primary/20 hover:shadow-lg hover:shadow-gray-200/50 hover:-translate-y-0.5 transition-all duration-300 flex-shrink-0 cursor-default">
