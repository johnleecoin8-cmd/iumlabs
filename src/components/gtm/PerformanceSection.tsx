...
const allProjects = [
  ...
  // Story Protocol hidden
  {
    ...
    slug: 'mantra',
    logo: mantraLogo,
    bgImage: '/images/posters/mantra-hero-poster.jpg',
  ...
  // Row 2 (← left)
  {
    ...
    slug: 'bnb-chain',
    logo: bnbLogo,
    bgImage: '/images/posters/bnb-hero-poster.jpg',
  ...
  },
  {
    ...
    slug: 'bybit',
    logo: bybitLogo,
    bgImage: '/images/posters/bybit-hero-poster.jpg',
  ...
  },
  {
    ...
    slug: 'kucoin',
    logo: kucoinLogo,
    bgImage: '/images/posters/kucoin-hero-poster.jpg',
  ...
  // Row 3 (→ right)
  {
    ...
    slug: 'sahara-ai',
    logo: saharaLogo,
    bgImage: '/images/posters/sahara-hero-poster.jpg',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/80 md:bg-black/80 max-md:bg-black/85" />
