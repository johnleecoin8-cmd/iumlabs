  ...
  return (
    <section ref={ref} className="px-4 bg-[#FAFAFA] overflow-hidden py-[20px] relative">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        {/* Horizontal Stepper with Colors */}
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div 
              ...
              style={{ 
                ...
                background: `linear-gradient(to right, ${steps.slice(0, activeStep + 1).map(s => s.color).join(', ')})`,
              }}
            />
            ...
            {steps.map((step, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative z-10 flex flex-col items-center group transition-all duration-300 ${isActive ? 'scale-105' : 'hover:scale-105'}`}
                >
                  {/* Step Circle */}
                  <div
        ...
        {/* Accordion Content - Colorful Card */}
              ...
              <div className="flex items-start gap-4">
                ...
                >
                  {(() => {
                    ...
                    return <IconComponent className="w-6 h-6" style={{ color: steps[activeStep].color }} />;
                  })()}
                </div>
        ...
        <div className="flex justify-center gap-2 mt-6 md:hidden">
          {steps.map((step, index) => (
            <button
              ...
              style={{
                backgroundColor: index === activeStep ? step.color : 'rgba(255,255,255,0.2)',
