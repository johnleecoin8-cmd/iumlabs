...
const ProjectMetrics = ({
  ...
  return <section className="bg-[#0F0F0F] relative overflow-hidden py-[30px]">
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 relative z-10 pt-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {metrics.map((metric, index) => <motion.div key={index} className="group relative p-6 md:p-8 rounded-2xl bg-[#111] overflow-hidden transition-all duration-300" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          border: `1px solid ${glowColor}20`
            ...
            background: `linear-gradient(to right, ${glowColor}, ${glowColor}40, transparent)`
          }} />
              
              {/* Corner Accent */}
              <div className="absolute top-0 right-0 w-20 h-20 opacity-20 group-hover:opacity-40 transition-opacity" style={{
            ...
            boxShadow: `inset 0 0 60px ${glowColor}20, 0 0 40px ${glowColor}15`
              ...
              <div className="relative">
                <p className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2 tracking-tight" style={{
              color: glowColor
            }}>
                  {metric.value}
                </p>
              ...
              <span className="absolute bottom-4 right-4 text-xs font-mono opacity-30" style={{
            color: glowColor
          }}>
                0{index + 1}
              </span>
