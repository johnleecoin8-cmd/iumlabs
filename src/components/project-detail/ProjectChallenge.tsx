...
const ProjectChallenge = ({
  ...
  return <section className="bg-[#121212] relative py-0">
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 pt-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          border: `1px solid ${glowColor}30`
            ...
            background: `linear-gradient(to right, ${glowColor}, ${glowColor}50, transparent)`
          }} />
            ...
            {/* Corner Glow */}
            <div className="absolute -top-20 -left-20 w-40 h-40 opacity-40" style={{
            ...
            {/* Decorative Number */}
            <span className="absolute bottom-6 right-6 text-8xl font-bold opacity-[0.05]" style={{
            color: glowColor
          }}>
              01
            </span>
          ...
          border: `1px solid ${glowColor}20`
            ...
            {/* Accent Line */}
            <div className="absolute top-0 left-0 w-full h-1" style={{
            background: `linear-gradient(to right, ${glowColor}60, ${glowColor}20, transparent)`
          }} />
            ...
            background: `linear-gradient(to right, ${glowColor}30, transparent)`
          }} />

            {/* Strategy Quote */}
            {strategy[0] && <p className="text-white/60 text-sm italic leading-relaxed">
                "{strategy[0]}"
              </p>}
