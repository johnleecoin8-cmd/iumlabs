...
const fallbackImages = [
  ...
  { src: kucoinCampaign, alt: "KuCoin Campaign", title: "KuCoin", subtitle: "Korea Campaign", slug: "kucoin" },
  { src: kucoinOldschool, alt: "KuCoin Oldschool", title: "KuCoin", subtitle: "Oldschool Event", slug: "kucoin" },
  { src: openledgerInterview, alt: "OpenLedger Interview", title: "OpenLedger", subtitle: "Media Interview", slug: "openledger" },
  { src: zkpassNights, alt: "zkPass Verifiable Nights", title: "zkPass", subtitle: "Verifiable Nights", slug: "zkpass" },
  { src: saharaAi, alt: "Sahara AI", title: "Sahara AI", subtitle: "Korea Launch", slug: "sahara-ai" },
  { src: synfuturesBillboard, alt: "SynFutures Billboard", title: "SynFutures", subtitle: "Billboard Campaign", slug: "synfutures" },
  { src: polygonConnect, alt: "Polygon Connect", title: "Polygon", subtitle: "Connect Event", slug: "polygon" },
  { src: polygonHackathon, alt: "Polygon Hackathon", title: "Polygon", subtitle: "Hackathon Korea", slug: "polygon" },
  { src: storyOriginSummit, alt: "Story Origin Summit", title: "Story Protocol", subtitle: "Origin Summit", slug: "story-protocol" },
  { src: storyWorkshop, alt: "Story Workshop", title: "Story Protocol", subtitle: "Developer Workshop", slug: "story-protocol" },
  { src: mantraParty, alt: "MANTRA Party", title: "MANTRA", subtitle: "Korea Community Party", slug: "mantra" },
  { src: mantra, alt: "MANTRA Event", title: "MANTRA", subtitle: "Korea Event", slug: "mantra" },
  { src: megaethLaunch, alt: "MegaETH Launch", title: "MegaETH", subtitle: "Korea Launch", slug: "megaeth" },
  { src: bybitEvent, alt: "Bybit Event", title: "Bybit", subtitle: "Korea Event", slug: "bybit" },
  { src: seoulMetroBillboardNew, alt: "Seoul Metro Billboard", title: "Seoul Metro", subtitle: "Billboard Campaign", slug: "seoul-metro" },
  { src: seoulMetroBillboard, alt: "Seoul Metro Billboard", title: "Seoul Metro", subtitle: "Station Campaign", slug: "seoul-metro" },
  { src: seoulMetroPoster, alt: "Seoul Metro Poster", title: "Seoul Metro", subtitle: "Poster Campaign", slug: "seoul-metro" },
];
