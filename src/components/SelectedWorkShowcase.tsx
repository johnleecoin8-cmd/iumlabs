      ...
      <div className="relative z-10 h-full flex">
        ...
        <div className="hidden lg:flex w-3/5 h-full items-center justify-end p-16 xl:p-20">
          ...
          delay: 0.3
            ...
            <p className="text-white/80 text-base xl:text-lg leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-2 gap-10 mb-10">
              <div className="text-right">
                <div className="text-4xl xl:text-5xl font-bold text-white">340%</div>
                <div className="text-sm text-white/40 mt-1">Avg. Volume</div>
              </div>
              <div className="text-right">
                <div className="text-4xl xl:text-5xl font-bold text-white">2.5M</div>
                <div className="text-sm text-white/40 mt-1">Organic Reaching</div>
              </div>
            </div>
            
            <Link to="/projects" className="inline-flex items-center gap-3 text-base text-white border border-white/30 px-8 py-4 hover:bg-white hover:text-black transition-all duration-300">
