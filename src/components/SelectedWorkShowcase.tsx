              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <span className={`flex-1 font-display text-base sm:text-2xl lg:text-3xl font-bold tracking-[-0.005em] leading-[1.05] transition-colors duration-200 group-hover:text-black ${activeIndex === i ? 'text-white' : 'text-white/60'}`}>
                      {project.name}
                    </span>
