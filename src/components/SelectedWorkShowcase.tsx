      ...
      <div className="relative z-10 h-full flex">
        ...
        <div className="hidden lg:flex w-1/2 h-full items-center justify-end p-16 xl:p-20">
          ...
          delay: 0.3
            ...
            <Link to="/projects" className="inline-flex items-center gap-2 text-sm text-white border border-white/30 px-6 py-3 hover:bg-white hover:text-black transition-all duration-300">
