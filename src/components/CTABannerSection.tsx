...
const CTABannerSection = () => {
  return <section className="bg-[#050508] py-24 md:py-36 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <CalendlyButton calendlyUrl="https://calendly.com/iumlabs-info/30min" className="bg-white text-black hover:bg-white/90 font-medium px-8 py-3 rounded-full" />
      </div>
    </section>;
};
