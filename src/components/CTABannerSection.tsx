      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 md:py-14 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            ...
            <button
              onClick={scrollToTop}
              className="group p-4 md:p-3 border border-border rounded-full hover:bg-secondary active:bg-secondary/80 hover:border-foreground/30 hover:-translate-y-0.5 hover:scale-105 hover:rotate-[-5deg] active:scale-95 hover:shadow-[0_5px_20px_-5px_rgba(255,255,255,0.2)] transition-all duration-300 min-w-[52px] min-h-[52px] flex items-center justify-center"
