...
export const allClientLogos: ClientLogo[] = [
  ...
  { name: "Story Protocol", logo: storyProtocolLogo, services: ["kol", "community", "yap"] },
  { name: "MegaETH", logo: megaethLogo, noInvert: true, services: ["yap", "kol", "community"] },
  { name: "Tria", logo: triaLogo, noInvert: true, services: ["yap", "community"] },
