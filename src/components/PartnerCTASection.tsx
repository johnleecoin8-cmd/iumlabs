...
const PartnerCTASection = () => {
  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 py-16 md:py-20 text-center">
        {/* Headline */}
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl font-extralight text-white leading-[1.2] tracking-wide mb-8"
        ...
        >
          한국 시장,
          <br />
          <span className="italic">같이 뚫자.</span>
        </motion.h2>
