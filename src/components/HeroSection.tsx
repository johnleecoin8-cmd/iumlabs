...
import heroVideoAsset from "@/assets/hero-background-v20260703.mp4.asset.json";
...
const HeroSection = () => {
  const {
    ...
    src: `${heroVideoAsset.url}?v=20260702b`,
    poster: '/images/posters/hero-background-poster.jpg?v=20260702b',
    autoPlay: true,
    preload: 'auto',
    lazyLoad: false,
