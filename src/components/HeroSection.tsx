...
const serviceTags = [
  ...
  { label: "KOL Marketing", position: "top-[15%] right-[6%]" },
  { label: "Media & PR", position: "top-[31%] right-[5%]" },
  { label: "SEO & Ads", position: "top-[47%] right-[7%]" },
  { label: "Offline Events", position: "top-[63%] right-[6%]" },
];
