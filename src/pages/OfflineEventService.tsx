      ...
      {seoulVenues.map((venue) => {
        ...
        return (
          <motion.div
            ...
            className={`absolute -translate-x-1/2 -translate-y-1/2 cursor-pointer ${isSelected ? 'z-40' : 'z-10'}`}
        ...
        <div className="border-t border-white/10">
          ...
          <div className="bg-[#1A1A1A] flex items-center justify-between p-4 md:px-10 md:py-4 border-b border-white/10">
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <h2 className="text-lg md:text-xl font-medium text-white">Event Journey</h2>
            </div>
            <span className="text-xs text-white/50 tracking-wider hidden sm:block px-3 py-1 border border-white/20 rounded-full">4-Week Program</span>
          </div>
