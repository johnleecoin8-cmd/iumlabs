...
import { Gamepad2, Video, Trophy, Users, Check, Calendar, ArrowRight, Quote } from "lucide-react";
...
const testimonials = [
  {
    quote: "CryptoBridge connected us with Korea's top gaming guilds, resulting in 100K+ new players within a month.",
    author: "Head of Growth",
    company: "P2E Game Studio",
    metric: "100K Players",
  },
  {
    quote: "Their streamer network gave us viral exposure across Korean gaming platforms we couldn't reach alone.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 animate-aurora">
            <div className="absolute inset-0 bg-gradient-to-tr from-green-600/20 via-transparent to-cyan-500/15" />
            <div className="absolute inset-0 bg-gradient-to-bl from-purple-600/10 via-transparent to-green-500/10" />
          </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10 pt-32 pb-24">
          <div className="mb-16">
            <span className="text-sm text-white/50 mb-4 block opacity-0 animate-fade-up" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>[ GameFi Marketing ]</span>
      ...
      <section ref={featuresRef} className="relative section-dark py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 animate-aurora pointer-events-none">
          <div className="absolute inset-0 bg-gradient-to-tr from-green-600/10 via-transparent to-cyan-500/5" />
          <div className="absolute inset-0 bg-gradient-to-bl from-purple-600/5 via-transparent to-green-500/5" />
        </div>
