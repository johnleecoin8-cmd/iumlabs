    ...
    <div className="svc-detail" ref={containerRef}>
      ...
      <section className="hero">
        ...
        <div className="wrap">
          ...
          <p className="hero-desc">Structured AMA sessions with native Korean-speaking hosts. Pre-event promotion, live moderation, post-AMA recap content and analytics. AMAs that move communities, not just timelines.</p>        </div>
      </section>
