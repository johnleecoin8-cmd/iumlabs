...
const CommunityService = () => {
  ...
  return <ServicePageLayout serviceName="Community Management" serviceTitle="Community" serviceSubtitle="Management" serviceDescription="Build thriving Discord & Telegram communities with AI-powered automation, gamified engagement, and 24/7 moderation." serviceIcon={Users} serviceTags={serviceTags} stats={stats} accentColor={ACCENT_COLOR} processSteps={processSteps} deliverables={deliverables} faqItems={faqItems} currentSlug="community">
