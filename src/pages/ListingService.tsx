...
const ListingService = () => (
  <ServiceTemplate
    ...
    features={[
      ...
      { icon: FileText, eyebrow: "02 · Package", title: "Application Packaging & Legal Opinion", body: "We assemble and localize the full application each venue expects, then coordinate the securities and legal opinions specific markets require, including the domestic Korean legal opinion KRW exchanges mandate, drafted through independent licensed counsel.", points: ["Whitepaper, cap table & corporate structure", "Audit, security & technical dossier", "Jurisdiction-specific legal opinions", "Korean securities opinion via KR counsel"], image: "" },
