    ...
    <div className="min-h-screen bg-[#0A0A0A]">
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 mt-16">
              <button
                ...
                className="p-3 rounded-full bg-white/5 border border-white/10 disabled:opacity-30 hover:bg-white/10 hover:border-primary/30 transition-all hover:scale-105 active:scale-95"
              >
              ...
              <div className="flex items-center gap-2">
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <button
                    ...
                    className={`w-10 h-10 rounded-full text-sm font-medium transition-all hover:scale-105 active:scale-95 ${
                      currentPage === page 
                        ? "bg-primary text-primary-foreground" 
                        : "bg-white/5 text-white/60 hover:bg-white/10 border border-white/10 hover:border-primary/30"
                    }`}
        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-8 py-20 text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <Input
              ...
              className="flex-1 bg-white/5 border-white/10 rounded-full px-6 h-14 text-white placeholder:text-white/40 focus:border-primary/50"
              required
            />
            <button
              type="submit"
              disabled={isSubscribing}
              className="group flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 h-14 text-sm font-medium rounded-full hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 disabled:opacity-50"
            >
      ...
      <section className="bg-[#0F0F0F] border-t border-white/10" id="cta">
        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-8 py-20 text-center">
          ...
          <CalendlyButton 
            className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 text-sm font-medium rounded-full hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300"
          >
