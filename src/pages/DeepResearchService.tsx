...
const DeepResearchService = () => (
  <ServiceTemplate
    ...
    reality={{
      ...
      body: ["The Upbit premium, DC Inside sentiment, Naver search trends, KakaoTalk group dynamics, these signals are invisible to anyone not operating inside the market daily. Global research firms hand you generic Asia-Pacific decks that lump Korea in with Japan.", "Korea is the third-largest crypto market in the world and deserves dedicated intelligence, not a footnote, whether you're a project sizing the opportunity or an exchange picking its next listing. We pair on-chain data with on-the-ground signal you can't get from a dashboard."],
    }}
    types={{
