    ...
    <div className="svc-detail" ref={containerRef}>
      ...
      <section className="hero">
        ...
        <div className="wrap">
          ...
          <p className="hero-desc">On-chain analytics, competitor analysis, market ecosystem mapping. Reports in Korean and English, distributed through our media network. Intelligence you can't get from a dashboard.</p>        </div>
      </section>
