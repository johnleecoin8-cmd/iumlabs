...
const GTMService = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Team inline cards — stagger reveal
      gsap.utils.toArray<HTMLElement>(".gtm-ed .tm-card-inline").forEach((card, i) => {
        gsap.from(card, { y: 40, opacity: 0, duration: .8, delay: i * .05, ease: "power3.out",
    ...
    <div className="gtm-ed" ref={containerRef}>
      ...
      <section className="approach-ed" id="approach">
        <div className="wrap">
          ...
          {/* TEAM — inside Approach */}
          <div className="team-inline">
            <div className="lbl" style={{ marginTop: "8rem" }}>The Team</div>
            <div className="team-grid-inline">
              {[
                ...
                <div key={m.name} className="tm-card-inline">
