  ...
  return <div className="min-h-screen bg-[#0A0A0A] md:snap-y md:snap-proximity md:overflow-y-auto md:h-screen scrollbar-hide">
      ...
      <section className="sm:px-4 sm:pt-3 snap-start">
        <div className="sm:rounded-3xl overflow-hidden bg-[#111] border border-white/[0.06] relative">
          <img src={ctaBgImage} alt="" className="absolute inset-0 w-full h-full object-cover opacity-[0.45]" width={1200} height={800} />
          ...
          <div className="relative px-5 sm:px-6 lg:px-10 py-16 sm:py-28">
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-[9px] sm:text-[11px] text-white/20 uppercase tracking-[0.3em] mb-4 sm:mb-5 font-mono">Seoul · Singapore</p>
              ...
              <p className="text-[13px] sm:text-[15px] text-white/25 max-w-md mx-auto mb-10 sm:mb-12 leading-relaxed font-light">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link to="/contact" className="inline-flex items-center px-7 py-3.5 sm:px-8 sm:py-4 rounded-full border border-white/[0.08] text-white/40 text-[13px] sm:text-sm font-medium hover:border-white/[0.15] hover:text-white/70 transition-all w-full sm:w-auto justify-center">
                  Send a Message
                </Link>
              </div>
            </div>
