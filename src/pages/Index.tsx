        ...
        <div className="sm:rounded-3xl overflow-hidden bg-[#111] border border-white/[0.06] relative">
          ...
          <div className="relative px-5 sm:px-6 lg:px-10 py-16 sm:py-28">
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-[9px] sm:text-[11px] text-white/30 uppercase tracking-[0.3em] mb-4 sm:mb-5 font-mono">Seoul · Singapore</p>
              ...
              <p className="text-[13px] sm:text-[15px] text-white/35 max-w-md mx-auto mb-10 sm:mb-12 leading-relaxed font-light">
